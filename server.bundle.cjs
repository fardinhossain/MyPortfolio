  ...
  try {
    ...
    return {
      ...
      body: {
        ...
        message: needsActivation ? "Direct messaging is awaiting one-time activation by the portfolio owner." : "Your message could not be sent right now. Please try again shortly."
      }
    };
  }
}
