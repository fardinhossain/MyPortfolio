        ...
        <div class="contact-terminal__details">
          ...
          <div class="contact-terminal__grid">
            <div class="contact-terminal__item">
              ...
              <a href="https://mail.google.com/mail/u/0/?extsrc=mailto&amp;url=${encodeURIComponent('mailto:' + RESUME_DATA.contact.email)}" target="_blank" rel="noopener noreferrer" class="contact-terminal__item-value contact-terminal__item-value--link">${RESUME_DATA.contact.email}</a>
            </div>
            <div class="contact-terminal__item">
