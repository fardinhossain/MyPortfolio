  ...
  certifications: [
    {
      ...
      certificateImage: "/cpte_fardin.jpg",
      certificateAlt: "C)PTE Certified Penetration Testing Engineer certificate for Md. Fardin Hossain",
      certificate: true,
    },
    "AI Engineer for Developers Associate (Datacamp)",
    {
      id: "edge-cuet-penetration-testing",
      title: "Applied Penetration Testing Engineer: Hands-on (EDGE-CUET)",
      issuer: "EDGE-CSE CUET DST Project",
      certificateImage: "/EDGE-CUET.jpg",
      certificateAlt: "Applied Penetration Testing Engineer Hands-on EDGE-CUET certificate for Md. Fardin Hossain",
      certificate: true,
    },
